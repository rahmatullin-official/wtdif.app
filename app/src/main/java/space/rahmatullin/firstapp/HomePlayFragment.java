...
public class HomePlayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<String> dialogs = Arrays.asList("Наконец-то я дома! Сейчас быстренько сделаю все уроки и посмотрю наконец-то мультики!",
                ...
                "Ну что, маму проводил, пора садиться за уроки. " + myPlayer.Name + " спустя три часа...", "Что?! Видимо я уснул, сколько времени прошло? " +
        ...
        switch (cnt) {
            case 1:
                ...
                secondButton.setOnClickListener(view -> {
                    myPlayer.points += 100;
                    requireActivity().runOnUiThread(() -> homePlayView.findViewById(R.id.point1)
            ...
            case 2:
                ...
                thirdButton.setOnClickListener(view -> {
                    myPlayer.points += 100;
                    requireActivity().runOnUiThread(() -> homePlayView.findViewById(R.id.point2)
                            .setBackgroundResource(R.drawable.style_points_green));
            ...
            case 3:
                ...
                firstButton.setOnClickListener(view -> {
                    myPlayer.points += 100;
                    requireActivity().runOnUiThread(() -> homePlayView.findViewById(R.id.point3)
                            .setBackgroundResource(R.drawable.style_points_green));
            ...
            case 4:
                ...
                secondButton.setOnClickListener(view -> {
                    myPlayer.points += 100;
                    requireActivity().runOnUiThread(() -> homePlayView.findViewById(R.id.point4)
                            .setBackgroundResource(R.drawable.style_points_green));
            ...
            case 5:
                ...
                firstButton.setOnClickListener(view -> {
                    myPlayer.points += 100;
                    requireActivity().runOnUiThread(() -> homePlayView.findViewById(R.id.point5)
                            .setBackgroundResource(R.drawable.style_points_green));
            ...
            case 6:
                ...
                firstButton.setOnClickListener(view -> {
                    myPlayer.points += 100;
                    requireActivity().runOnUiThread(() -> homePlayView.findViewById(R.id.point6)
                            .setBackgroundResource(R.drawable.style_points_green));
            ...
            case 7:
                ...
                firstButton.setOnClickListener(view -> {
                    myPlayer.points += 100;
                    requireActivity().runOnUiThread(() -> homePlayView.findViewById(R.id.point7)
                            .setBackgroundResource(R.drawable.style_points_green));
            ...
            case 8:
                ...
                List<String> list8 = Arrays.asList("Я не могу так рисковать. Дойду до выхода пешком.", "Хм, кажется лифт сломался. Всё таки хорошо что я на нем не поехал/поехала, " +
                        "не хватало во время пожара застрять в лифте…", "Ура пожарные как раз подоспели!");
                firstButton.setOnClickListener(view -> deathDialog(myPlayer));
                secondButton.setOnClickListener(view -> {
                    myPlayer.points += 100;
                    requireActivity().runOnUiThread(() -> homePlayView.findViewById(R.id.point8)
                            .setBackgroundResource(R.drawable.style_points_green));
                    timerText(homePlayView, 3, list8, myPlayer, cnt);
                });
                break;
            case 9:
                requireActivity().runOnUiThread(() -> {
                ...
                firstButton.setOnClickListener(view -> {
                    ...
                    requireActivity().runOnUiThread(() -> {
                        homePlayView.findViewById(R.id.point9)
                                .setBackgroundResource(R.drawable.style_points_green);
                        List<String> listLast = Arrays.asList("Здравствуйте, это я вам звонил/звонила. " +
                        ...
                        timerText(homePlayView, 2, listLast, myPlayer, cnt);
                    });
                });
                break;
        }
